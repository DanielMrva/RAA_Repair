...
@Component({
  selector: 'app-invoice-text-button',
  templateUrl: './invoice-text-button.component.html',
  styleUrls: ['./invoice-text-button.component.css']
})
export class InvoiceTextButtonComponent {
