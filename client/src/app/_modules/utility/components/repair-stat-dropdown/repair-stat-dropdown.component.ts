...
@Component({
  selector: 'app-repair-stat-dropdown',
  templateUrl: './repair-stat-dropdown.component.html',
  styleUrls: ['./repair-stat-dropdown.component.css'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => RepairStatDropdownComponent),
      multi: true
    }
  ]
})
export class RepairStatDropdownComponent implements OnInit, ControlValueAccessor {
